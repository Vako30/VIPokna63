                                                ...
                                                <div class="field-item even" property="content:encoded">
                                                    <div class="out out-pattern" style="opacity: 1;">
                                                          <span style="color:#ff0000; font-size:24px;font-weight:bold;">«VIP-ОКНА»</span>
                                                                   <span style="font-size:20px;"> — это производитель окон, который начал свое развитие в 1993 в Армении,
                                                   ...
                                                   <p style="color: rgb(61, 61, 64); font-family: Calibri, Helvetica, Arial; font-size: 20px; line-height: 24px;">
                                                        <strong>
                                                            <span style="color:#000000;font-size:20px;">Мы рады предложить Вам:</span>
                                                        </strong>
                                                    </p>
                                                    ...
                                                    <div class="twocolumns"  style="margin: 0px 0px 20px; padding: 0px; color: rgb(61, 61, 64); font-family: Calibri, Helvetica, Arial; font-size: 20px; line-height: 24px;">
                                                        <ul style="margin: 28px -10px 20px -50px; padding-right: 0px; padding-left: 0px; list-style: none; zoom: 1;">
                                                            ...
                                                            <li  class="col-md-6 col-xs-12">
                                                                <strong><span style="color:#000000;"><img src="http://www.mosokna.ru/bitrix/templates/mosokna/images/icon_feat_brush.png" />Оперативный </span><a
                                                            ...
                                                            <li class="col-md-6 col-xs-12">
                                                                <strong><span style="color:#000000;">
                                                                        <img src="http://www.mosokna.ru/bitrix/templates/mosokna/images/icon_feat_like.png"/></span>
                                ...
                                <form class="webform-client-form" enctype="multipart/form-data" action="/main"
                                    ...
                                    <div>
                                        ...
                                        <div class="form-item webform-component webform-component-textarea" id="webform-component-message">
                                            <div class="form-textarea-wrapper"><textarea id="edit-submitted-message" name="submitted[message]" cols="60" rows="5" class="form-textarea"></textarea>
                                            </div>
                                        </div>
