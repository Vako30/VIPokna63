    ...
    <div class="content">
        <div class="field-item even col-xs-12" property="content:encoded">
            ...
            <div class="twocolumns"  style="margin: 0px 0px 20px; padding: 0px; color: rgb(61, 61, 64); font-family: Calibri, Helvetica, Arial; font-size: 20px; line-height: 24px;">
                <h3 class="h1" style="text-align:center; color:#ff0000">Мы рады предложить Вам</h3>
                <ul style="padding-right: 0px; padding-left: 0px; list-style: none; zoom: 1;">
                    ...
                    <li  class="col-md-6 col-xs-12 icons-li">
                        <strong><span style="color:#000000;">
                                <img style="margin-right:15px" src="http://www.mosokna.ru/bitrix/templates/mosokna/images/icon_feat_star.png"/>Квалифицированный подход к решению задач любой сложности.</span></strong>
                    </li>
                    <li class="col-md-6 col-xs-12 icons-li">
                        <strong><span style="color:#000000;">
                                <img style="margin-right:15px"  src="http://www.mosokna.ru/bitrix/templates/mosokna/images/icon_feat_brush.png" />Оперативный </span><a
                                href="http://www.mosokna.ru/uslugi/montaj/" ><span
                    ...
                    <li class="col-md-6 col-xs-12 icons-li">
                        <strong><span style="color:#000000;">
                            <img style="margin-right:15px" src="http://www.mosokna.ru/bitrix/templates/mosokna/images/icon_feat_like.png"/></span>
